...
{
    public static final String[] LEAF_TYPES = new String[] {"alpha"};
    public static final String[][] field_94396_b = new String[][] {{"mullak99:leaves_alpha"}, {"mullak99:leaves_alpha_opaque"}};
    ...
    public alphaLeaves(int par1)
    {
        super(par1, Material.leaves, false);
        this.setTickRandomly(true);
        this.setCreativeTab(mullak99.tabMullak99sModWIP);
    }

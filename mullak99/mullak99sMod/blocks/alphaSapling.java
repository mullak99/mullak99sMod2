...
public class alphaSapling extends BlockFlower
{
    public static final String[] WOOD_TYPES = new String[] {"alpha"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    public alphaSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l == 1)
        {
            object = new WorldGenAlphaTree(true);
        }
        else if (l == 2)
        {
            object = new WorldGenAlphaTree(true);
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new WorldGenAlphaTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon(this.getTextureName());
        }
    }
}

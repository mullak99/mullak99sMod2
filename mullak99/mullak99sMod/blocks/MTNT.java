...
import mullak99.mullak99sMod.entity.EntityMTNTPrimed;
...
public class MTNT extends Block
{
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        ...
        if (mullak99.WillMTNTExplode) {
        	mullakCore.addChatMSG(mullak99Util.MTNTWARNING);
        	...
        	mullakCore.addChatMSG(mullak99Util.MTNTDisabledMSG);
        	return;
        }
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
    {
    	if(mullak99.WillMTNTExplode) {
	        ...
	        {
	            EntityMTNTPrimed entitytntprimed = new EntityMTNTPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par5Explosion.getExplosivePlacedBy());
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5, EntityLivingBase par6EntityLivingBase)
    {
    	if(mullak99.WillMTNTExplode) {
	        if (!par1World.isRemote)
	        {
	            if ((par5 & 1) == 1)
	            {
	                EntityMTNTPrimed entitytntprimed = new EntityMTNTPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par6EntityLivingBase);
	                par1World.spawnEntityInWorld(entitytntprimed);
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("mullak99:MTNT");
        this.field_94393_a = par1IconRegister.registerIcon("mullak99:blockMullite");
        this.field_94392_b = par1IconRegister.registerIcon("mullak99:blockMullite");
    }
}
